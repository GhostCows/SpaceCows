...
import br.senai.sc.engine.*;

public abstract class Test extends Canvas {
	...
	public Test() {
		...
		this.init();
		this.container.setOpacity(0.55f);
	...
	public Test(String nomeJogo, int width, int height) {
	...
	public void tocarAudio(String nome) {
		String audioName = ((Mp3)this.musicas.get(nome)).getAudioName();
		this.musicas.remove(nome);
		Mp3 mp3 = new Mp3();
		mp3.carregar(audioName);
		this.musicas.put(nome, mp3);
		((Mp3)this.musicas.get(nome)).iniciar();
	}
